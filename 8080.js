...
const ah_update_delay = 13 / 22 * 1200; // задержка для обновления аукциона

const mitaBuy_version = "1.1";
...
app.get('/', async (req, res) => {
  try {
    ...
    const response = await axios.get(`https://raw.githubusercontent.com/mitaArk/html/refs/heads/main/autosell.html`);
